...
public class Clothing_womens extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.women_clothing);
        ...
        prod1.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Clothing_womens.this , add_address.class);
//                startActivity(intent);
                String btnText1 = prod1.getText().toString();
                String ssplit[] = btnText1.split(" ");
                //Intent i3 = new Intent(Clothing_womens.this,Cart.class );
                intent.putExtra("price1", ssplit[3]);
                startActivity(intent);
